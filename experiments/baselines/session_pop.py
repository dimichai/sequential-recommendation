...
class SessionPop:
    ...
    support_by_key : string or None
        If not None, count the number of unique values of the attribute of the training data given by the specified header.
        If None, count the events. (Default value: None)

    """

    top_n: int
    item_key: string
    support_by_key: string
    pop_list: pd.Series
    prev_session_id: int
