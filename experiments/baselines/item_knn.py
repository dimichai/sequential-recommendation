...
class ItemKNN:
    ...
    def __init__(self, n_sims=100, lmbd=20, alpha=0.5, session_key='search_id', item_key='itemId', time_key='timestamp'):
        self.n_sims = n_sims
        self.lmbd = lmbd
        self.alpha = alpha
    ...
    def fit(self, data):
        ...
        data: pandas.DataFrame
            ...
            It has one column for session IDs, one for item IDs and one for the timestamp of the events (unix timestamps).
            It must have a header.
            Column names are arbitrary, but must correspond to the ones you set during the initialization of the network (session_key, item_key, time_key properties).
